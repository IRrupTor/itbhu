	...
	<div class="yjnewsflashu">
		<div class="yjnewsflashu_in yjnfitem<?php echo $item_get['item_id']// news item id. We add this to div class so it can be used for individual item styling?><?php echo $last ?>">
			...
			<div class="itemdetails">
				...
				<div class="itemcdate">
				<?php 
					$getdate = $item_get['item_date'];
					$getdate = explode(' ', $getdate);
					$getdate[0] = '<span class="month">'.$getdate[0].'</span>';
					$getdate[1] = '<span class="day">'.$getdate[1].'</span>';
					$getdate= join(' ', $getdate);
					echo $getdate // News item create date?>
                </div>
				<?php endif; ?>
			</div>
			<?php endif; ?>
