...
$current_template = $app->getTemplate(true)->template;
$pageClass = $this->params->get('pageclass_sfx');
//if (JRequest::getCmd( 'layout' ) == ''.$current_template.'youjoomla'){
//		$document->addStyleSheet(JURI::base().'templates/'.$current_template.'/css/youjoomla_blog.css');
//}
$document->addStyleSheet(JURI::base().'templates/'.$current_template.'/css/youjoomla_blog.css');
?>
<div class="YjCategoryView yjsg-newsitems<?php echo $pageClass;?>">
